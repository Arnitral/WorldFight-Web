...
/** @type {string} */
const CACHE_VERSION = '1773243768|9968222532';
/** @type {string} */
const CACHE_PREFIX = 'World Fight Offl-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'DEBUG_WorldFight_A2.0126.P0.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["DEBUG_WorldFight_A2.0126.P0.html","DEBUG_WorldFight_A2.0126.P0.js","DEBUG_WorldFight_A2.0126.P0.offline.html","DEBUG_WorldFight_A2.0126.P0.icon.png","DEBUG_WorldFight_A2.0126.P0.apple-touch-icon.png","DEBUG_WorldFight_A2.0126.P0.audio.worklet.js","DEBUG_WorldFight_A2.0126.P0.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["DEBUG_WorldFight_A2.0126.P0.wasm","DEBUG_WorldFight_A2.0126.P0.pck"];
